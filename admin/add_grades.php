                ...
                <div class="inputs">
                    ...
                    <div class="input-form">
                        <select name="class[]" class="select" required>
                            ...
                            <?php
                                $select_class = $conn->prepare("SELECT class_id as 'class_id', subj.name as 'subjects' from classes class left join subjects subj on class.subject_id = subj.subject_id where employee_id");
                                $select_class->execute();
                                $result = $select_class->get_result();
...
$(document).ready(function() {
        ...
        $(document).on('click', '.add-more', function(){
            $('.new-form').append(`<?php
                ...
                $select_class = $conn->prepare("SELECT class_id as 'class_id', subj.name as 'subjects' from classes class left join subjects subj on class.subject_id = subj.subject_id where class_id");
                $select_class->execute();
                $result = $select_class->get_result();
                $classes_options = "";
                if ($result->num_rows > 0) {
